from skills_ml.job_postings.corpora import SectionExtractCorpusCreator
...
def test_SectionExtractCorpusCreator():
    job_posting_generator = [sample_posting]
    corpus_creator = SectionExtractCorpusCreator(section_regex='Qualifications', job_posting_generator=job_posting_generator)
